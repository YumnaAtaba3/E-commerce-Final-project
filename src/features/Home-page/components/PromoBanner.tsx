...
const PromoBanner: React.FC = () => {
  ...
  const renderCircle = (value: number, label: string, shortLabel: string) => (
    <Box
      sx={{
        bgcolor: "white",
        color: "black",
  ...
  return (
    ...
    >
      <Container maxWidth="xl">
        <Grid container alignItems="center" spacing={{ xs: 4, md: 4, lg:4 ,xl:20 }}>
          {/* Left Content */}
          <Grid item xs={12} md={6}>
            ...
            <Box sx={{ display: "flex", mb: 3, flexWrap: "wrap" }}>
              {renderCircle(timeLeft.days, "Days", "D")}
              {renderCircle(timeLeft.hours, "Hours", "H")}
              {renderCircle(timeLeft.minutes, "Minutes", "M")}
              {renderCircle(timeLeft.seconds, "Seconds", "S")}
            </Box>
